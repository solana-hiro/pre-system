...
, function(t, e) {
    ...
    t.exports = function() {
        return function(t, e, s, a) {
            return a = a || {},
            a.test && a.getElementsByClassName || !a.test && document.getElementsByClassName ? r(t, e, s) : a.test && a.querySelector || !a.test && document.querySelector ? n(t, e, s) : i(t, e, s)
        }
    }()
}
, function(t, e) {
    ...
    t.exports = function(t) {
        var e = function(e, i) {
            ...
            for (var m = 1; m <= c; m++) {
                ...
                g && n(s.elm).add(g),
                a(s.elm, m, u)) : r.dotted(e, m, d, v, f, h, e.size()) && (s = e.add({
                    page: "...",
                    dotted: !0
                })[0],
    ...
    t.exports = function(t) {
        var e = {
          ...
          , r = function() {
            ...
            r.order = e.getOrder(n)) : (r = arguments[1] || r,
            r.valueName = arguments[0],
            r.order = r.order || "asc",
            r.insensitive = "undefined" == typeof r.insensitive || r.insensitive),
            e.clear(),
            e.setOrder(r);
...
, function(t, e) {
    var r = function(t) {
        var e, r = this, n = function() {
            ...
            e && (e = r.clearSourceItem(e, t.valueNames))
        };
        this.clearSourceItem = function(e, r) {
            for (var n = 0, i = r.length; n < i; n++) {
                ...
                if (r[n].data)
                    ...
                    r[n].attr && r[n].name ? (s = t.utils.getByClass(e, r[n].name, !0),
                    s && s.setAttribute(r[n].attr, "")) : (s = t.utils.getByClass(e, r[n], !0),
                    s && (s.innerHTML = ""));
                s = void 0
            }
            return e
        ...
        this.get = function(e, n) {
            ...
            for (var i = {}, s = 0, a = n.length; s < a; s++) {
                ...
                if (n[s].data)
                    ...
                    n[s].attr && n[s].name ? (o = t.utils.getByClass(e.elm, n[s].name, !0),
            ...
            var i = function(e) {
                for (var r = 0, n = t.valueNames.length; r < n; r++)
                    if (t.valueNames[r].data) {
                        ...
                        if (t.valueNames[r].attr && t.valueNames[r].name && t.valueNames[r].name == e)
              ...
              , s = function(r, n) {
                ...
                s && s.setAttribute(a.attr, n)) : (s = t.utils.getByClass(e.elm, a, !0),
                s && (s.innerHTML = n)),
                s = void 0)
            };
            if (!r.create(e))
        ...
        for (var r = (t += "").length, i = (e += "").length, s = 0, l = 0; s < r && l < i; ) {
            ...
            if (n(u)) {
                ...
                if (m)
                    return m;
                for (; f < d; )
                    if (m = t.charCodeAt(f++) - e.charCodeAt(h++))
                        return m;
                s = d,
                l = v
            } else {
                if (u !== c)
                    return u < o && c < o && a[u] !== -1 && a[c] !== -1 ? a[u] - a[c] : u - c;
                ++s,
                ++l
            }
        }
...
, function(t, e) {
    t.exports = function(t, e, r) {
        ...
        var o = i
          ...
          , u = a
          , c = t.indexOf(e, o);
        c != -1 && (u = Math.min(n(0, c), u),
        c = t.lastIndexOf(e, o + e.length),
        c != -1 && (u = Math.min(n(0, c), u)));
        var f = 1 << e.length - 1;
        c = -1;
