...
<table>
    <thead>
        ...
        <tr>
            ...
            <th style="text-align:left;">売上数量1</th>
            <th style="text-align:left;">サイズコード2</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量2</th>
            <th style="text-align:left;">サイズコード3</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量3</th>
            <th style="text-align:left;">サイズコード4</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量4</th>
            <th style="text-align:left;">サイズコード5</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量5</th>
            <th style="text-align:left;">サイズコード6</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量6</th>
            <th style="text-align:left;">サイズコード7</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量7</th>
            <th style="text-align:left;">サイズコード8</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量8</th>
            <th style="text-align:left;">サイズコード9</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量9</th>
            <th style="text-align:left;">サイズコード10</th>
            <th style="text-align:left;">サイズ名</th>
            <th style="text-align:left;">売上数量10</th>
