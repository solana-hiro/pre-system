...
<table>
    <thead>
        ...
        <tr>
            ...
            <th style="text-align:left;">{{ $params['brandStartCode'] }}</th>
            <th style="text-align:left;">～</th>
            <th style="text-align:left;">{{ $params['brandEndCode'] }}</th>
        </tr>
        <tr>
        ...
        <tr>
			...
			<th style="text-align:left;">商品分類コード</th>
			<th style="text-align:left;">商品分類名</th>
