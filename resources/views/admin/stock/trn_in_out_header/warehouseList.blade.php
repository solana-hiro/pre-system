...
@section('page_title', '商品別倉庫別在庫一覧表')
@section('title', '商品別倉庫別在庫一覧表')
@section('description', '')
@section('keywords', '')
@section('canonical', '')

@section('content')
    <form role="search" action="{{ route('stock_management.stock.warehouse.list.export') }}" method="post"
        ...
        <div class="main-area">
            ...
            <div class="box">
                <div class="element-form element-form-rows">
                    ...
                    <div class="frame">
                        <div class="textbox">
                            <input type="text" name="year" class="element textbox_40px" minlength="0" maxlength="4"
                                value="{{ date('Y') }}">年
                            <input type="text" name="month" class="element textbox_24px" minlength="0" maxlength="2"
                                value="{{ date('m') }}">月
                            <input type="text" name="day" class="element textbox_24px" minlength="0" maxlength="2"
                                value="{{ date('d') }}">日
                    ...
                    <div class="frame">
                        <div class="div">
                            <label class="text_wrapper_2">
                                <input type="radio" id="output_kbn_1" name="output_kbn" value="1"
                                    onclick="outputKbnClick();" checked />
                                商品別
                            </label>
                        </div>
                        <div class="div">
                            <label class="text_wrapper_2">
                                <input type="radio" id="output_kbn_2" name="output_kbn" value="2"
                                    onclick="outputKbnClick();" />
                                カラー別サイズ別
                            </label>
                        </div>
                    </div>
            ...
            <div class="element-form element-form-rows" id="color_code" style="display:none;">
            ...
            <div class="element-form element-form-rows" id="size_code" style="display:none;">
