...
@section('content')
    <form role="search" action="{{ route('stock_management.stock.list.export') }}" method="post" name="mtItemClassListForm">
        @csrf
        <div class="main-area">
                    ...
                    <div class="frame">
                        <div class="textbox">
                            ...
                            <input type="text" name="month" class="element textbox_24px" minlength="0" maxlength="2"
                                value="{{ date('m') }}">月
                            <input type="text" name="date" class="element textbox_24px" minlength="0" maxlength="2"
                                value="{{ date('d') }}">日
