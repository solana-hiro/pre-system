...
@section('content')
    <form role="search" action="{{ route('stock_management.inventory.slip.export') }}" method="post"
        ...
        <div class="main-area">
            ...
            <div class="box">
                ...
                <div class="element-form element-form-rows">
                    <div class="text_wrapper">商品コード出力条件</div>
                    <div class="frame">
                        <div class="div">
                            <label class="text_wrapper_2">
                                <input type="radio" id="" name="output_kbn" value="0" checked />
                                在庫分
                            </label>
                        </div>
                        <div class="div">
