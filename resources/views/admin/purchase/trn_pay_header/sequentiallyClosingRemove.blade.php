...
@section('page_title', '支払随時締解除処理')
@section('title', '支払随時締解除処理')
@section('description', '')
@section('keywords', '')
@section('canonical', '')

@section('content')
	<form role="search" action="{{ route('purchase_management.pay.sequentially.closing.remove.update') }}" method="post">
	    @csrf
		<div class="main_contents">
			...
			<div class="box">
				...
				<div class="group">
				    <div class="element-form element-form-rows">
						<div class="text_wrapper">今回支払締日付
							<div class="frame">
								<div class="textbox">
								    <input type="text" name="name" class="element textbox_40px" minlength="0" maxlength="4" value="">年
								    <input type="text" name="name" class="element textbox_24px" minlength="0" maxlength="2" value="">月
