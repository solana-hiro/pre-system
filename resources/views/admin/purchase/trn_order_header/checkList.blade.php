...
@section('page_title', '発注チェックリスト')
@section('title', '発注チェックリスト')
@section('description', '')
@section('keywords', '')
@section('canonical', '')

@section('content')
    <form role="search" action="{{ route('purchase_management.order.checklist.export') }}" method="post">
        @csrf
        <div class="main-area">
            ...
            <div class="element-form element-form-rows">
                ...
                <div class="frame">
                    ...
                    <div class="div">
                        <label class="text_wrapper_2">
                            <input type="radio" id="" name="report_kbn" value="2" />
                            SKU単位（マトリックス）
                        </label>
                    </div>
                </div>
            ...
            <div class="element-form element-form-rows">
                ...
                <div class="frame">
                    <div class="textbox">
                        <input type="text" name="manager_cd_start" class="element" minlength="0" maxlength="6"
                            size="6" />
                        <img class="vector" src="/img/icon/vector.svg" />
                    </div>
                    <div class="text_wrapper">～</div>
                    <div class="textbox">
                        <input type="text" name="manager_cd_end" class="element" minlength="0" maxlength="6"
                            size="6" />
                        <img class="vector" src="/img/icon/vector.svg" />
                    </div>
                </div>
            ...
            <div class="element-form element-form-rows">
                <div class="text_wrapper label">発注伝票No.範囲</div>
                <div class="frame">
                    <div class="textbox">
