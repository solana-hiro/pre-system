...
@section('page_title', '請求データ確定処理')
@section('title', '請求データ確定処理')
@section('description', '')
@section('keywords', '')
@section('canonical', '')
...
@section('content')
    <form role="search" action="{{ route('sales_management.demand.data.decision.update') }}" method="post">
        @csrf
        <div class="main-area">
            <div class="button_area">
                <div class="div">
                    ...
                    <button type="button" data-toggle="modal" data-target="#modal_remove_confirm" data-value=""
                        ...
                        <div class="text_wrapper">解除する</div>
                    </button>
