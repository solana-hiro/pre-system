...
@section('page_title', '得意先別商品分類掛率マスタ リスト')
@section('title', '得意先別商品分類掛率マスタ リスト')
@section('description', '')
@section('keywords', '')
@section('canonical', '')
...
@section('content')
    <form role="search" action="{{ route('master.price.mt_customer_other_item_class_rate.export') }}" method="post">
        @csrf
        <div class="main-area">
            ...
            <div class="element-form element-form-rows">
                ...
                <div class="frame">
                    ...
                    <div class="textbox">
                        <input type="number" name="customer_code_end" class="element w-24" data-limit-len="6"
            ...
            <div class="element-form element-form-rows">
                <div class="text_wrapper label">ブランド１コード範囲</div>
                <div class="frame">
                    <div class="textbox">
                        <input type="text" name="brand_code_start" class="element" maxlength="6" size="6"
                            value="{{ old('brand_code_start', '') }}" />
                        <img class="vector" id="img_brand_code_start" src="/img/icon/vector.svg"
                            data-smm-open="search_brand1_modal">
                    </div>
                    <div class="text_wrapper">～</div>
                    <div class="textbox">
                        <input type="text" name="brand_code_end" class="element" maxlength="6" size="6"
                            value="{{ old('brand_code_end', '') }}" />
                        <img class="vector" id="img_brand_code_end" src="/img/icon/vector.svg"
                            data-smm-open="search_brand1_modal">
                    </div>
                </div>
            </div>
        ...
        <input type="hidden" id="hidden_brand_code_start" value="" name="hidden_brand_code_start" />
        <input type="hidden" id="hidden_brand_code_end" value="" name="hidden_brand_code_end" />
