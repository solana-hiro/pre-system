            ...
            <div class="button_area">
                <div class="div">
                    ...
                    @else
                        ...
                        <a href="{{ route('master.price.mt_customer_other_item_class_rate.page_by_id_for_new', ['id' => $customer->id ?? 0]) }}"
                            rel="next"
                                ...
                                <tr class="!h-8">
                                    ...
                                    <td class="grid_col_2 col_rec !w-[40px] !px-1">
                                        <input type="number" name="item_classes[{{ $i }}][rate]"
                                            value="{{ old("item_classes.$i.rate") }}" class="grid_textbox text-right"
                                    ...
                                    <td class="grid_col_4 col_rec col_rec_noline !w-[20px] !px-0"></td>
                                    <td class="grid_col_2 col_rec !w-[40px] !px-1">
                                        <input type="number" name="item_classes[{{ $i }}][now_rate]"
                                            class="grid_textbox text-right"
                                            value="{{ old("item_classes.$i.now_rate", $itemClassRates[$i]->rate ?? '') }}"
                                            readonly>
                                    </td>
                                    <td class="grid_col_4 col_rec_noline !w-[20px] !px-0">%</td>
                                    <td class="grid_col_4 col_rec !px-1">
                                        @include('admin.master.price.date_form', [
                                            ...
                                            'paramName' => "item_classes[$i][now_start]",
                                            'oldParamName' => "item_classes.$i.now_start",
                                            'width' => [
                                                'year' => '!w-[36px]',
                                                'month' => '!w-[18px]',
                                                'day' => '!w-[18px]',
                                    ...
                                    <td class="grid_col_4 col_rec !px-1">
                                        @include('admin.master.price.date_form', [
                                            ...
                                            'paramName' => "item_classes[$i][now_end]",
                                            'oldParamName' => "item_classes.$i.now_end",
                                            'width' => [
                                                'year' => '!w-[36px]',
                                                'month' => '!w-[18px]',
                                                'day' => '!w-[18px]',
