            ...
            <div class="button_area">
                <div class="div">
                    ...
                    @else
                        ...
                        <a href="{{ route('master.price.mt_customer_other_item_rate.page_by_id_for_fix', ['id' => $customer->id ?? 0]) }}"
                            rel="next"
                                ...
                                <tr class="!h-8 {{ $i % 2 === 0 ? 'bg-tr-white' : 'bg-tr-yellow' }}">
                                    ...
                                    <td rowspan="2" class="grid_col_2 col_rec !w-[40px] !px-1">
                                        <input type="number" name="items[{{ $i }}][rate]"
                                            value="{{ old("items.$i.rate", $itemRates[$i]->rate ?? '') }}"
                                    ...
                                    <td rowspan="2" class="grid_col_4 col_rec col_rec_noline !w-[20px] !px-0"></td>
                                    <td rowspan="2" class="grid_col_2 col_rec !w-[40px] !px-1">
                                        <input type="number" name="items[{{ $i }}][old_rate]"
                                            class="grid_textbox text-right"
                                            value="{{ old("items.$i.old_rate", $itemRates[$i]->old_rate ?? '') }}"
                                            readonly>
                                    </td>
                                    <td rowspan="2" class="grid_col_4 col_rec_noline !w-[20px] !px-0">%</td>
                                    <td rowspan="2" class="grid_col_4 col_rec !px-1">
                                        @include('admin.master.price.date_form', [
                                            'initialDate' => $itemRates[$i]?->old_start_date ?? null,
                                            'paramName' => "items[$i][old_start]",
                                            'oldParamName' => "items.$i.old_start",
                                            'width' => [
                                                'year' => '!w-[36px]',
                                                'month' => '!w-[18px]',
                                                'day' => '!w-[18px]',
                                    ...
                                    <td rowspan="2" class="grid_col_4 col_rec !px-1">
                                        @include('admin.master.price.date_form', [
                                            'initialDate' => $itemRates[$i]?->old_end_date ?? null,
                                            'paramName' => "items[$i][old_end]",
                                            'oldParamName' => "items.$i.old_end",
                                            'width' => [
                                                'year' => '!w-[36px]',
                                                'month' => '!w-[18px]',
                                                'day' => '!w-[18px]',
