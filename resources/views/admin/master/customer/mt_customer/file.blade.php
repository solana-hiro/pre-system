...
@section('page_title', '得意先マスタExcel取込')
@section('title', '得意先マスタExcel取込')
...
@section('content')
	<div class="main-area">
		<form role="search" action="{{ route('master.customer.mt_customer.file.import') }}" method="post" name="mtCustomerFileImportForm" enctype="multipart/form-data">
	    @csrf
			<div class="button_area">
				<div class="div">
                    @if(Session::has('customerImportError'))
                    ...
                    <button type="button" data-toggle="modal" data-target="#file_confirm1" data-value="" class="button-2" data-url="" name="update2"><div class="text_wrapper_3">実行する</div></button>
				</div>
	    	</div>
