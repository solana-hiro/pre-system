<div class="modal-box  modal-box-w550px" id="customer_balance">
	<div class="modal-content">
	    <header class="header">
	        <div class="text-wrapper">得意先残高検索</div>
	        <div>
	        	<img class="modal-close" id="modal-close" src="{{ asset('/img/icon/modal_close.svg') }}" />
	        </div>
	    </header>
	    <form method="post" action="{{ route('master.search.customer') }}">
				...
				<div class="grid">
					<table class="table_sticky">
						<thead class="gray_header">
							<tr>
								<td class="grid_wrapper_center td_50p" colspan="2">売掛帳簿残高</td>
							</tr>
							<tr>
			...
			<div class="flex_item">
				<div class="grid">
					<table class="table_sticky">
						<thead class="gray_header">
							<tr>
								<td class="grid_wrapper_center td_50p" colspan="2">請求帳簿残高</td>
							</tr>
							<tr>
								<td class="grid_wrapper_center">設定日</td>
								<td class="grid_wrapper_center">金額</td>
				...
				<div class="grid">
					<table class="table">
						<thead class="grid_header">
							<tr>
								<td class="grid_wrapper_center td_50p" colspan="2">売掛登録残高</td>
							</tr>
							<tr>
								<td class="grid_wrapper_center">設定日</td>
								<td class="grid_wrapper_center">金額</td>
			...
			<div class="flex_item">
				<div class="grid">
					<table class="table_sticky">
						<thead class="grid_header">
							<tr>
								<td class="grid_wrapper_center td_50p" colspan="2">請求登録残高</td>
							</tr>
							<tr>
								<td class="grid_wrapper_center">設定日</td>
								<td class="grid_wrapper_center">金額</td>
