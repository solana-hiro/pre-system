...
@section('page_title', 'カラーパターンリスト（一覧）')
@section('title', 'カラーパターンリスト（一覧）')
@section('description', '')
@section('keywords', '')
@section('canonical', '')
...
@section('content')
    <form role="search" action="{{ route('master.item.mt_color_pattern.export') }}" method="post">
        @csrf
        <div class="main-area">
            ...
            <div class="element-form">
                <div class="text_wrapper">カラーパターンコード範囲</div>
                <div class="frame">
                    <div class="textbox">
