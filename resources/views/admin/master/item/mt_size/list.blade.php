...
@section('page_title', 'サイズリスト（一覧）')
@section('title', 'サイズリスト（一覧）')
@section('description', '')
@section('keywords', '')
@section('canonical', '')
...
@section('content')
    <form role="search" action="{{ route('master.item.mt_size.export') }}" method="post">
        @csrf
        <div class="main-area">
    ...
    <script>
        ...
        //     if("" !== inputBox.value) {
        //         inputBox.value = inputBox.value.toString().padStart(5, '0');
        //     }
        // };
        // outputBox.onblur = function () {
        //     if("" !== outputBox.value) {
        //         outputBox.value = outputBox.value.toString().padStart(5, '0');
        //     }
        // };
    </script>
@endsection
