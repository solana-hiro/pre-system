...
@section('content')
    <form role="search" action="{{ route('master.other.mt_warehouse.export') }}" method="post">
        @csrf
        <div class="main-area">
            ...
            <div class="element-form element-form-rows">
                ...
                <div class="frame">
                    ...
                    <div class="textbox">
                        <input type="number" name="code_end" id="input_code_end" class="element input_number_6"
