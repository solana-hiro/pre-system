...
class PriceRateForItem implements ValidationRule
{
    private $rate;
    private $startYear;
    private $startMonth;
    ...
    {
        $this->rate = __('validation.attributes.mt_customer_other_item_rates.rate');
        $this->startYear = __('validation.attributes.mt_customer_other_item_rates.start.year');
        $this->startMonth = __('validation.attributes.mt_customer_other_item_rates.start.month');
        $this->startDay = __('validation.attributes.mt_customer_other_item_rates.start.day');
        $this->endYear = __('validation.attributes.mt_customer_other_item_rates.end.year');
        $this->endMonth = __('validation.attributes.mt_customer_other_item_rates.end.month');
        $this->endDay = __('validation.attributes.mt_customer_other_item_rates.end.day');
    }
    ...
    {
        return is_null($value['mt_customer_other_item_rate_id'])
            && !is_null($value['item_cd']);
    }
