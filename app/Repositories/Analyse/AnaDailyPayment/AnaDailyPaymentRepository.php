...
namespace App\Repositories\Analyse\AnaDailyPayment;
...
class AnaDailyPaymentRepository extends AnalyseRepositoryBase implements AnalyseRepositoryInterface
{
    const DEF_SELECT = [
    ...
    private function query()
    {
        $query = TrnPaymentDetail::select(...self::DEF_SELECT)
            ...
            ->leftJoin('mt_users', 'mt_users.id', '=', 'trn_payment_headers.mt_user_last_update_id');
        return $query;
    }
