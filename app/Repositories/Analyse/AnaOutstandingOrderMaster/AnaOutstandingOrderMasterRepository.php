...
namespace App\Repositories\Analyse\AnaOutstandingOrderMaster;
...
class AnaOutstandingOrderMasterRepository extends AnalyseRepositoryBase implements AnalyseRepositoryInterface
{
    const DEF_SELECT = [
        ...
        'trn_order_details.memo',
        'trn_order_details.memo2',
        'trn_order_details.order_finish_flg',
        'mt_suppliers.supplier_cd',
        'mt_suppliers.supplier_name',
        'trn_order_headers.partner_number',
        'trn_order_headers.slip_memo',
    ];
    ...
    {
        $query = parent::filterByValue($params, $query, 'trn_order_headers', 'order_number');
        ...
        $query = parent::filterByValue($params, $query, 'trn_order_details', 'memo2');
